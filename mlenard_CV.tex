...
\begin{tablist}
	...
	\begin{itemize} \begin{footnotesize}
		...
		\item - Cleaning natural history data and fitting it to appropriate data models
...
\begin{tablist}
	...
	\item[2021] \tab \textbf{Lenard, M.}; Thomer, A. K. Title for NAS report appendix.
...
\begin{itemize}
	...
	\item Experience with Darwin Core, MARC, BIBFRAME, XML, JSON, RDF, RDFS, SKOS, OWL, PROV, and various other data and metadata standards
